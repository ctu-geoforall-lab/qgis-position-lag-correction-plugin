...
/***************************************************************************
 Position correction
                                 A QGIS plugin
 This script creates the core of plugin - runs it and creates the basic
    interactions with QGIS
                              -------------------
        begin                : 2016-02-12
        git sha              : $Format:%H$
...
class PositionCorrection:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GPS position lag correction',
                                          message)
